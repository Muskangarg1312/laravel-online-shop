                ...
                <form action="#" method="GET">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href = '{{ route('sub-categories.index') }}' " class="btn btn-default btn-sm1">Reset</button>
                        </div>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        @if ( $subCategory->media)
                                            <img src="{{ asset('storage/'.$subCategory->media->name) }}" alt="" width="30px" height="30px" class="rounded-circle">
                                        @endif
                                    </td> --}}
                                    <td>
