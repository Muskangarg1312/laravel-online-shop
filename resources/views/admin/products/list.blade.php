            ...
            <form action="#" method="GET">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href = '{{ route('products.index') }}' " class="btn btn-default btn-sm1">Reset</button>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('storage/product/small/'.$productImage->image) }}" class="img-thumbnail" width="50" >
                                @else
                            ...
                            <td>{{ $product->price }}</td>
                            <td>{{ $product->qty ? $product->qty : 0 }} left in Stock</td>
                            <td>{{ Str::upper($product->sku) }}</td>											
                            <td>
