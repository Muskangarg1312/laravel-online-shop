                ...
                <form action="#" method="GET">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href = '{{ route('categories.index') }}' " class="btn btn-default btn-sm1">Reset</button>
                        </div>
                            ...
                            @if ($categories->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ( $category->media)
                                            {{-- {{ $category->media->name }} --}}
                                            <img src="{{ asset('storage/'.$category->media->name) }}" alt="" width="30px" height="30px" class="rounded-circle">
                                        @endif
                                    </td>
                                    <td>
