                                ...
                                <div class="row align-items-center">
                                    <div class="col-4 col-md-3 col-xl-2">
                                        ...
                                        @endphp
                                          ...
                                          <img class="img-fluid" src="{{ asset('storage/product/small/'.$productImage->image) }}" ></a>
                                          @else
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="mb-4 fs-sm fw-bold">
                                            <a class="text-body" href="{{ route('front.product', $product->slug) }}">{{ $orderItem->name }} x {{ $orderItem->qty }}</a> <br>
