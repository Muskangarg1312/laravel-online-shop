...
<body data-instant-intensity="mousedown">
                ...
                <div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                    ...
                    <form action="{{ route('front.shop') }}" method="GET">					
                        <div class="input-group">
                            <input type="search" placeholder="Search For Products" class="form-control" name="search" value="{{ Request::get('search') }}" id="search">
    ...
    <!-- Wishlist Modal -->
    <div class="modal fade" id="wishlistModal" tabindex="-1" aria-labelledby="wishlistModalLabel" aria-hidden="true" style="margin: 25vh auto;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title text-white" id="wishlistModalLabel">Success ❤️</h5>
                    {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
                </div>
                <div class="modal-body">
                </div>
                <div class="modal-footer bg-dark flex justify-content-between">
                    <div>
                        <a href="{{ route('account.wishlist') }}" class="btn btn-primary float-left text-left">Go to Wishlist</a>
                    </div>
